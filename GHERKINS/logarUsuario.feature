...
Funcionalidade: logar com usuario
    ...
    SENDO que podera navegar na pagina de produto para adicionar no carinho 
...
Dado adicionar novos produtos no carinho
Quando estando na pagina de produto
E depois indo na pagina do carinho para fazer compra ou cancelar  

Cenário:Estar na pagina de no carinho  
Quando  
Então  
