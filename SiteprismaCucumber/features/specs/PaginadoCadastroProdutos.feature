...
Funcionalidade: Página de cadastro de Produto
    ...
    Contexto: Estar na pagina de Cadastro de Produtos
        ...
        Quando <adicionar> novo produto que foi lançado de coleções 

    Cenário: 
        Quando <Cadastrar> novo produtos nos campos obrigarios e prenchido corretamente
        Então Sera colocado para ser na pagina lista de produtos para ser <vendido> no ecommerce 
...
| TV         |                 |  Internet sem fio  |     9999         |       false      |  Campos de preço e imagem obrigatori   |
